# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD5" CASE STUDY             """
...
sysname = 'XFD5' # Name of the System
nodenames = ['CLEAK', 'CLEAK2'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (10, 90, 1.000, 0, 5, 1.275, 65.000, 40000.000, 2, 'CLEAK', '.txt', '.csv', -9),
    (18, 90, 1.000, 0, 5, 1.275, 65.000, 40000.000, 2, 'CLEAK', '.txt', '.csv', -9)
]
