# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD8" CASE STUDY             """
...
sysname = 'XFD8' # Name of the System
nodenames = ['HDRA', 'HDRA2'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (0, 1, 1.000, 0, 3, 0.29, 70.000, 30.000, 2, 'SUBRFA', '.csv', '.csv', -9),
    (0, 1, 1.000, 0, 3, 0.29, 70.000, 30.000, 1, 'SUBRFA', '.csv', '.csv', -9)
]
