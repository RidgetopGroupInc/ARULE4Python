# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD2" CASE STUDY             """
...
sysname = 'XFD2' # Name of the System
nodenames = ['ROTOGB1', 'ROTOGB2'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (5.2, 0.000, 5.000, 0, 5, 0.925, 40.000, 100.000, 5, 'ROTOGB1', '.csv', '.csv', -9), 
    (5.2, 0.000, 5.000, 0, 5, 0.925, 40.000, 100.000, 5, 'ROTOGB2', '.csv', '.csv', -9)
]
