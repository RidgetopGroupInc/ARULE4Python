# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD6" CASE STUDY             """
...
sysname = 'XFD6' # Name of the System
nodenames = ['BATTIR'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (25, 10, 1.000, 0, 5, 1.00, 70.000, 500.000, 2, 'BATTIR', '.csv', '.csv', -9)
]
