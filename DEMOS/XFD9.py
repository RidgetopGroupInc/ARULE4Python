# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD9" CASE STUDY             """
...
sysname = 'XFD9' # Name of the System
nodenames = ['VR2400', 'EMARSPHT', 'EMASTPHA', 'EMASWPHB'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (100, 200, 5.000, 0, 5, 2.05, 65.000, 250.000, 4, 'VR2400', '.csv', '.csv', -9),
    (125, 0, 4.000, 0, 5, 1.25, 60.000, 30.000, 2, 'EMARSPHT', '.csv', '.csv', -9),
    (120, 80, 1.000, 0, 5, 1.3, 45.000, 30.000, 2, 'EMASTPHA', '.csv', '.csv', -9),
    (115, 80, 1.000, 0, 5, 1.25, 45.000, 30.000, 2, 'EMASWPHB', '.csv', '.csv', -9)
]
