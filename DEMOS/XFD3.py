# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD3" CASE STUDY             """
...
sysname = 'XFD3' # Name of the System
nodenames = ['VRPCAP', 'VR2400'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (10.000, 30.000, 5.000, 0, 5, 0.3650, 70.000, 65000.000, 2, 'VRPCAP', '.csv', '.csv', -9), 
    (100.000, 200.000, 5.000, 0, 5, 2, 60.000, 250.000, 4, 'VR2400', '.csv', '.csv', -9)
]
