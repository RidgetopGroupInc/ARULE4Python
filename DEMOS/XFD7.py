# ========================================================================
"""         ARULE IN PYTHON DEMO FOR THE "XFD7" CASE STUDY             """
...
sysname = 'XFD7' # Name of the System
nodenames = ['BATTCHG1', 'BATTCHG2', 'BATTCHG3'] # Name of Nodes
### SDEF
system_node_list = [
...
### NDEF
node_params = [
    (0.055, 0.19, 1.000, 0, 5, 1.50, 70.000, 120.000, 2, 'BHCHG', '.csv', '.csv', -9),
    (10, 23, 1.000, 0, 5, 1.50, 70.000, 120.000, 2, 'CS-CHGWC', '.csv', '.csv', -9),
    (10, 23, 1.000, 0, 5, 1.50, 70.000, 120.000, 2, 'CS-CHGBC', '.csv', '.csv', -9)
]
